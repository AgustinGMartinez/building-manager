...
function validateAdmin(admin) {
  ...
  var _Joi$validate = Joi.validate(admin, schema),
...
router.get('/', authenticated.superadmin, /*#__PURE__*/function () {
...
router.post('/', authenticated.superadmin, /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(req, res, next) {
    var _req$body, username, password, name, lastname, isSuperadmin, queryString, result, saltedPassword;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _req$body = req.body, username = _req$body.username, password = _req$body.password, name = _req$body.name, lastname = _req$body.lastname, isSuperadmin = _req$body.isSuperadmin;
...
router.delete('/:id', authenticated.superadmin, /*#__PURE__*/function () {
